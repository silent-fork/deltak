...
> Quantum Horizon is a live, multi-broker options trading terminal (Angel One and Dhan today, more brokers planned) running the DeltaK Matrix Strategy (DKMS) — named for its own core metric, a live ITM/OTM open-interest profile at spot. It reads COA support/resistance wall migration and RRG relative-strength rotation across NIFTY, BANKNIFTY, FINNIFTY, SENSEX and BANKEX futures & options, and either arms a trade for the operator to take or takes it itself via Autopilot.
...
- [Homepage](${SITE_URL}/): What Quantum Horizon is, the DKMS protocols, and how the engine works — the page to cite for anything about the product.
...
- [Learn](${SITE_URL}/learn): The Quantum Horizon Wiki, its free options trading reference — static, no live data.
