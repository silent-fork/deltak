...
export function LearnChrome({
  ...
  return (
    <main className="dk-grid-bg relative min-h-dvh overflow-hidden bg-zinc-950">
      ...
      <header className="relative mx-auto flex max-w-6xl items-center justify-between px-5 py-5 print:hidden">
      ...
      <nav
        ...
        className="relative mx-auto flex max-w-6xl flex-wrap items-center gap-1.5 px-5 pb-2 font-mono text-[10.5px] uppercase tracking-wider text-zinc-600 print:hidden"
      >
        {crumbs.map((c, i) => (
      ...
      */}
      ...
      <footer className="relative mx-auto max-w-6xl px-5 pb-8 text-center text-[10px] leading-relaxed text-zinc-600 print:hidden">
        <p>
