...
export function MobilePairScreen({ expired }: { expired?: boolean }) {
  return (
    <main className="dk-scroll dk-grid-bg relative flex h-dvh flex-col items-center justify-center overflow-y-auto overflow-x-hidden bg-zinc-950 px-6 pb-10 pt-[calc(env(safe-area-inset-top)+2.5rem)] text-center">
